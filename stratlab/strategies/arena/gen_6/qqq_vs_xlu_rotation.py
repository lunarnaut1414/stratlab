"""QQQ vs XLU binary momentum rotation.

Hypothesis: Hold QQQ (Nasdaq-100, tech-heavy) or XLU (utilities, defensive),
whichever has the higher 60-day total return. 5-bar minimum hold.
97% concentration in winner.

Rationale:
- QQQ dominates in tech-led, low-rate bull markets
- XLU leads in risk-off, rate-falling, recession environments
- QQQ/XLU pair has stronger contrast than QQQ/XLV (healthcare has growth)
- XLU drops sharply in rising-rate environments (2013-2018), making QQQ
  the clear winner for most of the IS window

Structural distinctions:
- Uses QQQ (Nasdaq-100) instead of XLK (sp500 tech) as tech proxy
- XLU is rate-sensitive, creating sharper contrast vs XLK/XLU (gen5 accepted at 0.587)
- All-equity, no bonds
"""
...
class QQQvsXLURotation(Strategy):
    """Rank QQQ vs XLU by 60d momentum; hold the stronger ETF fully."""
...
UNIVERSE = ["QQQ", "XLU"]
NAME = "qqq_vs_xlu_rotation"
HYPOTHESIS = (
    "QQQ vs XLU binary rotation: hold whichever of QQQ or XLU has higher 60d momentum; "
    "5-bar minimum hold; full 97% concentration; "
    "pure tech/growth vs utilities/defensive rotation"
)
STRATEGY = QQQvsXLURotation()
